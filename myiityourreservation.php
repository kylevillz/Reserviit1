              ...
              <div class="box-footer">
                ...
                <table id = "tableappointment" class = "table table-striped"  >
                  ...
                  <tbody>
                    ...
                    $empty = "";
                    $phrase = "Not yet done";
                    $select=$pdo->prepare("select * from tbl_appointment where name='". $_SESSION['username']."' AND  customerid = '".$_SESSION['customerid'] ."' AND appointment_status='$empty' OR name='". $_SESSION['username']."' AND  customerid = '".$_SESSION['customerid'] ."'AND appointment_status= '$phrase' ORDER BY appointmentid DESC ");
