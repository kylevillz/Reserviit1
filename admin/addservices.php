...
if ($f_extension == 'jpg' || $f_extension == 'png' || $f_extension == 'gif' || $f_extension == 'jpeg') {
  ...
  if($file_size>=5000000) {
    ...
    if (move_uploaded_file($file_tem_loc, $file_store)) {
      ...
      $upload = $f_newfile;
      if(!isset($error)){
        $insert=$pdo->prepare("insert into tbl_building(buildingname,category,saleprice,description,image)
        values(:buildingname,:category,:saleprice,:description,:image)");
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Venue</label>
                    <input type="text" class="form-control" name="txtbuildingname" placeholder="Enter name..." required>
                  </div>
                  <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info" name="btnaddservice">Add Venue</button>
