            ...
            <table class = "table table-striped" id="tableservice">
              ...
              <tbody>
                ...
                while ($row=$select->fetch(PDO::FETCH_OBJ)) {
                  ...
                  <td>'.$row->role.'</td>
                  <td>
                  <button id='.$row->userid.'  class="btn btn-danger btndelete"><span class = "glyphicon glyphicon-trash" style = "color:#ffffff" data-toggle="tooltip" title="delete"></span></button>
                  </td>
                  </tr>';
                }
