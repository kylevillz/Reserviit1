            ...
            <table id="tablecategory" class = "table table-striped">
              ...
              <tbody>
                ...
                while($row=$select->fetch(PDO::FETCH_OBJ)){
                  ...
                  <td>
                  <button type="submit" value="'.$row->catid.'" class="btn btn-danger" name="btndelete"><span class = "glyphicon glyphicon-trash" style = "color:#ffffff"  title="delete"></span></button>
                  </td>
