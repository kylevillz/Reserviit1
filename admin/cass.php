      ...
      <!--------------------------
        ...
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title"><a href="addavailability.php" class="btn btn-primary" role="button">Add Schedule</a></h3>
          </div>
            ...
            <div class="box-body">
              <table id = "tableservice" class = "table table-striped"  >
                ...
                <tbody>
                  ...
                  <?php
                  $phrase = 'cass';
                  $select=$pdo->prepare("select * from tbl_availability where buildingname ='$phrase' ");
                  ...
                  while($row=$select->fetch(PDO::FETCH_OBJ)){
                    ...
                    <td>
                    <a href = "editavailability.php?id='.$row->availid.'"  class="btn btn-info" role = "button" ><span class = "glyphicon glyphicon-edit" style = "color:#ffffff" data-toggle="tooltip" title="edit"></span></a>
                    </td>
                    <td>
