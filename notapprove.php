  ...
  <body>
    <div class="wrapper">
      <nav>
        ...
        <div class="content">
          ...
          <ul class="links">
            <li><a href="myiit.php">Home</a></li>
            <li><a href="#" onclick="swal('Authenticate Account!','Your account has not yet been approved!','warning')">Reservation</li></a><br>
            <li>
              ...
              <ul>
                ...
                <li><a href="#" onclick="swal('Authenticate Account!','Your account has not yet been approved!','warning')">Your Reservations</a></li>
    ...
    <div class="banner">
      <div class="banner-content">
        ...
        <button class="btn" ><span></span><a href="verify.php" style="color: white">VERIFY ACCOUNT</a> </button>
