...
$query   = "SELECT tbl_availability.bid, tbl_availability.buildingname , tbl_building.saleprice FROM `tbl_availability`
...
elseif(!empty($name) AND !empty($buildingname) AND !empty($date) AND !empty($customerid)){
  $insert=$pdo->prepare("insert into tbl_appointment(name,customerid,bid,buildingname,roomnumber,reserve_date,reserve_time,reserve_endtime,role,description)
  values(:name,:customerid,:bid,:buildingname,:roomnumber,:reserve_date,:reserve_time,:reserve_endtime,:role,:description)");
...
$.ajax({
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="myiit.php"><i class="fa fa-dashboard"></i> Level</a></li>
